...
public protocol SAPinViewControllerDelegate: class {
    ...
    func setPinViewTitle() -> String
    
    func enterPinViewTitle() -> String
    
    func repeatPinViewTitle() -> String
...
open class SAPinViewController: UIViewController {
    ...
    fileprivate func setAttributedTitleForButtonWithTitle(_ title: String, font: UIFont, color: UIColor) {
        cancelButton.setAttributedTitle(NSAttributedString(string: title, attributes: [NSFontAttributeName:font,NSForegroundColorAttributeName:color]), for: UIControl.State())
    }
    ...
    fileprivate func configureNextPage() {
        tappedButtons = []
        setAttributedTitleForButtonWithTitle(SAPinConstant.CancelString, font: cancelButtonFont, color: cancelButtonColor)
        for item in circleViews {
        ...
        if tappedButtons.count < 4 {
            ...
            if tappedButtons.count == 4 {
                ...
                case .set:
                    ...
                    titleText = delegate.repeatPinViewTitle()
                    configureNextPage()
                case .confirm:
                    ...
                    if newPin == repeatedPin {
                        ...
                        subtitleText = delegate.repeatPasswordError()
                        pinErrorAnimate()
                        tappedButtons = []
                        setAttributedTitleForButtonWithTitle(SAPinConstant.CancelString, font: cancelButtonFont, color: cancelButtonColor)
                    }
